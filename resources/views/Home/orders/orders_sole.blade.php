            ...
            <table class="layui-table" lay-even="" lay-skin="nob" lay-size="sm">
                ...
                @foreach($orders as $k=>$v)
                    <tr>
                        ...
                        <td>
                            @if($v['ostatus'] == 0)
                                <a class="status" oid="{{$v['oid']}}"> <button class="layui-btn layui-btn-danger layui-btn-sm">发货</button></a>
                            @elseif($v['ostatus'] == 1)
                                <font color="#FF5722">等待收货</font>
                            @elseif($v['ostatus'] == 2)
                                订单已完成
                            @endif
                        </td>
            ...
            $('.status').each(function(){
                $(this).click(function(){
                    ...
                    layer.confirm('确定发货？', {
                        ...
                        location.href = '/home/user/orders/send/'+oid;
                    }, function(){
