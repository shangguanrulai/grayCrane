                ...
                <div class="step-box" id="step1">
                    ...
                    <ul class="form-box">
                        <li class="form-group clearfix">
                            ...
                            <input type="text" class="form-control" name="rec" value="{{$addr['rec']}}" lay-verify="required">
                        </li>
                        <li class="form-group clearfix">
                            <label for="passwd1" class="control-label">手机号：</label>
                            <input type="text" class="form-control" name="phone" value="{{$addr['phone']}}" lay-verify="phone">
                        </li>
                        <li class="form-group clearfix">
                            <label for="passwd1" class="control-label">邮编：</label>
                            <input type="text" class="form-control" name="code" value="{{$addr['code']}}">
