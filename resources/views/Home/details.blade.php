...
<html lang="zh-CN">
<head>
    <title>【Hasselblad 500 C/M    +    CF80】- 蜂鸟二手交易平台</title>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" Content="IE=edge,chrome=1"/>
    <meta name="renderer" Content="webkit">
    <meta name="csrf-param" Content="_csrf">
    <meta name="csrf-token" Content="NU5URXU2UWRUGx4dJxseDXoXMQ0jZR1WDTkCFyFMISMHfB4xH0Q9Ng==">
    <meta http-equiv="mobile-agent" Content="format=html5; url=http://m.2.fengniao.com/"/>
        <meta name="keywords" Content="Hasselblad 500 C/M    +    CF80行情,Hasselblad 500 C/M    +    CF80价格,Hasselblad 500 C/M    +    CF80评论在蜂鸟二手交易平台">
<meta itemprop="name" Content="Hasselblad 500 C/M    +    CF80">
<meta itemprop="image" Content="https://2.qn.img-space.com/201803/15/8d1a9beff5de5287eaa992b947a7c3c4.jpg?imageView2/2/w/418/h/312/q/90/ignore-error/1/">
<meta name="description" itemprop="description" Content="蜂鸟二手交易平台为您提供Hasselblad 500 C/M    +    CF80二手交易行情,报价,评论,选器材上蜂鸟二手">
<link href="http://m.2.fengniao.com/secforum/3266810.html" rel="alternate" media="only screen and (max-width: 640px)">
...
<!-- <script src="/Scripts/goodswidestyle.js"></script> --><div id="globalCeiling-topBar" style="height: 44px;background-color: #111111;"></div>
<!-- header -->
...
<div class="nav-link">
    ...
    <a href="/quality" target="_blank">鉴定<i class="new-icon">新</i></a>
    <a href="/service" target="_blank">维修</a>
<!--    <a href="--><!--" --><!-- target="_blank">商铺列表</a>-->
</div>    </div>
</div>
<!-- //homePage-nav-box -->
