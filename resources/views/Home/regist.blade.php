...
<div id="box" class="wrapper wrapper-box">
    ...
    <div class="content">
        ...
        <div class="register">
            ...
            <p class="">
                <font><i>*</i>用户名：</font>
                <span><input type="text" class="text-long" name="uname" id="username" autocomplete="off"/></span>
                <em></em>
            </p>
            <p class="">
                <font><i>*</i>密码：</font>
                <span><input type="password" class="text-long" name="upass" id="password" autocomplete="off"/></span>
                <em></em>
            </p>
			<!-- <p>
                <font><i>*</i>手机号：</font>
            ...
            <p>
                <font><i>*</i>验证码：</font>
                <span class="short"><input type="text" class="text-short"  name="yzm" id="code" autocomplete="off"/></span>
