                ...
                <div id="payItem1" class="tab-panel J_tabPanel"
                    ...
                    <div class="plat-pay-box J_switchTab">
                        <form method="get" action="/home/goods/success">
                                ...
                                <input style='margin:25px;width:500px;' type="password" class="form-control" id="exampleInputPassword1" placeholder="Password" name='payPass'> 
                                <em class='em'></em> 
                        ...
                        <!-- <script>
                            $('#wechatSubButton').click(function(){
                        
                        
                        
                                console.log(this);
                                var payPass = $('.form-control').val();
                        
                                if(payPass !== {{ $payPass }}){
                        
                                    $('.em').html('密码输入错误').css('color','red');
