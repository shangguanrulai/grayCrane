                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form action="/car/{{$cars->id}}" id="biaodan" class="am-form tpl-form-line-form" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                {{method_field('PUT')}}
                                ...
                                <div class="layui-form-item layui-form-text">
                                    ...
                                    <div class="layui-input-block" style="position:relative;left:270px;top:-30px;width:60px;height:60px">
                                        <input type="hidden" name="profile" value="{{$cars->profile}}">
                                        <img id="art_thumb" src="/uploads/{{$cars->profile}}" style="width:60px;">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        ...
                                        <textarea name="pmsg" class="tpl-form-input" id="" cols="30" rows="5">{{$cars->pmsg}}</textarea>
                                        <small></small>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="am-form-field tpl-form-no-bg" placeholder="" name="purl" value="{{$cars->purl}}">
                                        <small></small>
                                    </div>
                                </div>
