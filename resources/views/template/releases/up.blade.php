            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-nav-link">
                    ...
                    <ul class="sidebar-nav sidebar-nav-sub" style="display: block;">
                        <li class="sidebar-nav-link">
                            <a href="{{url('releases/up')}}">
                                <span class="am-icon-angle-right sidebar-nav-link-logo"></span> 已上架商品
                            </a>
                        </li>

                        <li class="sidebar-nav-link">
                            <a href="{{url('releases/await')}}" class="sub-active">
                                <span class="am-icon-angle-right sidebar-nav-link-logo"></span> 待审核商品
                            </a>
                        </li>
                    </ul>
                </li>
                                    ...
                                    <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black ">
                                        ...
                                        <body>
                                            <td class="gradeX">
                                                ...
                                                <td class="am-text-middle">1,0</td>
