            ...
            <div class="row">
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        ...
                        <form action="/perm" class="am-form tpl-form-line-form" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <table class="insert-tab" width="100%">
                                    ...
                                    <td>
                                        <select name="pid" id="catid" class="required">
                                            @foreach ($perm_cates as $k=>$v)
                                                ...
                                                echo "<option value={{$v->id}}>{{$v->pname}}</option>";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="common-text required" id="title" name="urls" size="50" value="" type="text">
                                    </td>
                                </tr>
                                <tr style="height:20px"></tr>
                                <tr>
