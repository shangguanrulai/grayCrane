            ...
            <ul class="guarantee-list clearfix">
                <li class="guarantee-item guarantee-item1">
                    ...
                    <ul class="guarantee-links">
                        <li><span class="link">最全二手品类</span></li>
    ...
    <ul class="clearfix">
        ...
        <li id="commonUserNameDialog" class="commonLoginDialog-form userName-dialog" style="display: none;">
            ...
            <dl class="other-commonLogin clearfix" style="display: none">
                <dt>其他登录方式：</dt>
                <dd>
                    <a target="_blank" href="http://my.fengniao.com/user/login-third-party?id=1&url=http%3A%2F%2F2.fengniao.com%2F" class="sina-link">新浪</a>
                    <a target="_blank" href="http://my.fengniao.com/user/login-third-party?id=2&url=http%3A%2F%2F2.fengniao.com%2F" class="wechat-link">微信</a>
                    <a target="_blank" href="http://my.fengniao.com/user/login-third-party?id=3&url=http%3A%2F%2F2.fengniao.com%2F" class="QQ-link">QQ</a>
                </dd>
            </dl>
        </li>
        <li id="otherLoginDialog" class="commonLoginDialog-form otherLogin-dialog" style="display: none;">
            ...
            <div class="other-login clearfix">
                <a target="_blank" href="http://my.fengniao.com/user/login-third-party?id=1&url=http%3A%2F%2F2.fengniao.com%2F" class="login-link link-sina">新浪微博</a>
                <a href="javascript:;" class="login-link link-scan-wechat">腾讯微信</a>
                <a target="_blank" href="http://my.fengniao.com/user/login-third-party?id=3&url=http%3A%2F%2F2.fengniao.com%2F" class="login-link link-QQ">腾讯QQ</a>
...
<div id="commonLoginPopupCaptcha"></div><div id="sidebarFixedNav" class="sidebar-fixed-nav">
    <div class="sidebar-nav-wrap">
        <ul class="sidebar-nav-item">
            <li class="nav-item item5"><a  target="_blank"  href="http://kefu.qycn.com/vclient/chat/?websiteid=123435"><i class="icon">在线客服</i><span class="text">在线客服</span></a></li>
            <li class="nav-item item6">
                <i class="icon">二维码</i>
            </li>
            <li class="nav-item item7"><a href="javascript:scroll(0,0)" target="_self"><i class="icon">返回顶部</i></a></li>
            <li class="nav-item item8"><a target="_blank" href="https://www.wjx.cn/jq/18979637.aspx?click_source=site_source"><i class="icon">用户反馈</i><span class="text">用户反馈</span></a></li>
        </ul>
        <div class="pic-box" style="visibility: hidden">
            <i class="closed">&times;</i>
            <img src="/Picture/1cf5fe69cbbb13e70a0221328eefa392.png">
        </div>
    </div>
</div>
{{--<script language="JavaScript" type="text/javascript" src="/Scripts/pv.js"></script>--}}
{{--<script>
    var _hmt = _hmt || [];
    (function () {
...
<script src="/Scripts/jquery.tinyscrollbar.2.4.2.min.js" 0="frontend\assets\BaseAsset" language="javascript" charset="UTF-8"></script>
<script src="/Scripts/jquery.cookie.1.4.0.js" 0="frontend\assets\BaseAsset" language="javascript" charset="UTF-8"></script>
{{--<script src="/Scripts/home-v3.js" 0="frontend\assets\BaseAsset" language="javascript" charset="UTF-8"></script></body>--}}
</html>
